...
public class ComposedRule {
    ...
    private List<String> comparisonConstraints;
    ...
    public List<String> getComparisonConstraints() {
        return comparisonConstraints;
    }

    public void setComparisonConstraints(List<String> comparisonConstraints) {
