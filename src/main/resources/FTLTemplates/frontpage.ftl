...
<div class="frontpage">
    <div class="section">
        <h1>Cryptographic API Documentation generated by Crypto<sub>DOC</sub></h1>
        <p>This documentation was created by Crypto<sub>DOC</sub> based on CrySL rules and complements the official <a target="_blank" rel="noopener noreferrer"
                                                                                                                           href="https://docs.oracle.com/javase/8/docs/api/java/security/package-summary.html">JavaDoc</a>.</p>
        <h2>First Steps</h2>
        <p>Are you new to documentation generated by Crypto<sub>DOC</sub>? Read the following instructions to get
            started!</p>
    ...
    <div class="section">
        ...
        <p>Want to analyse or generate secure code automatically? Find other use cases based on CrySL rules!</p>
        <ul>
